...
![Architecture Diagram](screenshots/UpdatedArchitecture.png)
...
![Dashboard](screenshots/CloudwatchDashboard.png)

### DynamoDB Table
![DynamoDB](screenshots/Dynamodbtableitems.png)

### SNS Email Alert
![SNS Alert](screenshots/SNSNotification.png)
